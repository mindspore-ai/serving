...
.. py:function:: mindspore_serving.server.start_servables(servable_configs, enable_lite=False)
    ...
    如何配置模型提供服务请查看
    `基于MindSpore Serving部署推理服务 <https://www.mindspore.cn/serving/docs/zh-CN/r2.0/serving_example.html>`_ 和
    `通过配置模型提供Servable <https://www.mindspore.cn/serving/docs/zh-CN/r2.0/serving_model.html>`_ 。
