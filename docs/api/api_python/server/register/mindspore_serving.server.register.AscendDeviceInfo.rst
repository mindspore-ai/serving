...
.. py:class:: mindspore_serving.server.register.AscendDeviceInfo(**kwargs)
    ...
    `ATC工具参数说明 <https://support.huaweicloud.com/tg-cannApplicationDev330/atlasatc_16_0037.html>`_ 。
    ...
    **参数：**
    ...
    - **buffer_optimize_mode** (str, optional) - 值可以是"l1_optimize"、"l2_optimize"、"off_optimize" 或者"l1_and_l2_optimize"。默认"l2_optimize"。
