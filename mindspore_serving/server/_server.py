...
def start_servables(servable_configs, enable_lite=False):
    ...
    On Ascend 310/310P and GPU hardware platform, one device can be shared by multi servables,
    and different servables or different versions of the same servable
    can be deployed on the same chip to realize device reuse.
    ...
    <https://www.mindspore.cn/serving/docs/en/r1.8/serving_example.html>`_ and
    `Servable Provided Through Model Configuration
    <https://www.mindspore.cn/serving/docs/en/r1.8/serving_model.html>`_.
