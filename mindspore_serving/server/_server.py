...
def start_servables(servable_configs, enable_lite=False):
    ...
    `MindSpore-based Inference Service Deployment <https://www.mindspore.cn/serving/docs/en/r1.9/serving_example.html>`_
    and `Servable Provided Through Model Configuration <https://www.mindspore.cn/serving/docs/en/r1.9/\
        serving_model.html>`_.
