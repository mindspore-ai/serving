...
def _generate_poly_lr(lr_init, _, lr_max, total_steps, warmup_steps):
    """
    Applies polynomial decay to generate learning rate array.

    Args:
       lr_init(float): init learning rate.
       _(float): end learning rate
       lr_max(float): max learning rate.
       total_steps(int): all steps in training.
       warmup_steps(int): all steps in warmup epochs.
...
def _generate_cosine_lr(lr_init, _, lr_max, total_steps, warmup_steps):
    """
